...
//  temp.b = b;
//  temp.c = c;
//  temp.printAnswer = function(){
//  console.log(temp.a + " + " + temp.b + " + " + temp.c + " : " + temp.answer)
//  };
//  return temp.answer = temp.a + temp.b + temp.c;
//
// };
// var questionOne = sum(1,2,3)
// questionOne.printAnswer;


// - If this is for the Accumulator problems, there are actually tests built into the page that will test your
// functions, so you would not have to call them.
// - The test is looking for a function named ‘sum’ , which takes an array (instead of 3 elements- your a,b,c).
// In this case the array will have three elements inside of it, but it could have any number of elements.
//
// => I would recommend trying to use a for loop to access the value of each element, as well as a temp variable
// to keep track of the sum.  Then you can return the temp variable at the end.
//
